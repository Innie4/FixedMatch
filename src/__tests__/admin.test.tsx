...
describe('Admin API', () => {
  ...
  // Removed all describe/it blocks for GET /api/admin/users, PUT /api/admin/users/:id, and GET /api/admin/stats, and any code referencing prisma, getUsers, updateUser, and getStats.
}); 