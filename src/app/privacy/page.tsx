      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          <div className="prose prose-blue dark:prose-invert max-w-none">
            ...
            <p>
              At Legit Soccer Tips, we respect your privacy and are committed to protecting your
            ...
            <p>
              ...
              products and Services, or otherwise contact us. The personal information we collect
              may include:
            </p>
            <ul>
            ...
            <ul>
              ...
              <li>
                Send administrative information, such as updates, security alerts, and support
                messages
              </li>
