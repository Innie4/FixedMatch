          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Our predictions have an average accuracy of 78% across all leagues. We continuously
                refine our models to improve accuracy.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Predictions are updated in real-time as new data becomes available. We factor in
                team news, injuries, and other relevant information.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Yes, we offer a 7-day money-back guarantee for all new subscribers. If you're not
                satisfied with our service, contact our support team.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                We cover over 30 leagues worldwide, including all major European leagues, South
                American competitions, and selected leagues from Africa, Asia, and North America.
              </p>
            </div>
          </div>
        </div>
